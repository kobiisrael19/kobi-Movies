        ...
        >
          <div className="carusel-img carousel-inner">
            <div className="carousel-item active" data-bs-interval="5100">
              <Link to={`/moviedeatels/tt6806448`}>
                <img
            ...
            <div className="carousel-item" data-bs-interval="11100">
              <Link to={`/moviedeatels/tt0848228`}>
                <img
                  style={{ width: "100%", height: "100%" }}
                  src="https://images.alphacoders.com/130/1300729.jpg"
                  className="d-block"
                  alt="..."
                />
              </Link>
            ...
            <div className="carousel-item" data-bs-interval="11100">
              <Link to={`/moviedeatels/tt0848228`}>
                <img
                  style={{ width: "100%", height: "100%" }}
                  src="https://images5.alphacoders.com/336/336484.jpg"
                  className="d-block"
                  alt="..."
                />
              </Link>
